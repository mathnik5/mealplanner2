...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.loggedIn
          ? const SelectDietPrefPgWidget()
          : const AuthenticationPgWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => MealSelectionPgWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: Test4Widget.routeName,
          path: Test4Widget.routePath,
          builder: (context, params) => const Test4Widget(),
        )
